...
helm ${kubeContextArg} ${namespaceArg} install -n lightning-kube-btcctl --set database=${database} ${serviceTypeArg} ${nodePortArg} --set image.tag=${imageTag} charts/lightning-kube-btcctl
